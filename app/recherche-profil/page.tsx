      ...
      <header className="bg-white border-b border-slate-200 h-16 flex items-center justify-between px-6 sticky top-0 z-10">
        <div className="flex items-center gap-4 relative">
          <button 
            ...
            className="p-2 -ml-2 text-[#32A8D7] hover:bg-blue-50 rounded-lg transition-colors"
          >
          ...
          {isMenuOpen && (
            <div className="absolute top-12 left-0 mt-3 w-52 bg-white rounded-3xl shadow-2xl border border-slate-100 py-2 z-30 animate-fade-in">
              ...
              <Link href="/talents" className="w-full text-left px-5 py-2.5 text-[13px] text-slate-700 hover:bg-slate-50 font-semibold flex items-center transition-colors">
                Talents
              </Link>
              <Link href="/recruteurs" className="w-full text-left px-5 py-2.5 text-[13px] text-slate-700 hover:bg-slate-50 font-semibold flex items-center transition-colors">
                Recruteurs
              </Link>
